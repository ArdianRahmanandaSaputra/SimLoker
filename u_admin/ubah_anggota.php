  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        $sql = "SELECT * FROM ANGGOTA WHERE ID='" . $_GET['ID'] . "'";
        ...
        <div class="body">
          <form role="frmUser" action="" method="POST">
            ...
            <div class="form-group">
              <div class="form-line">
                <input type="text" name="NAMA" class="form-control" value="<?php echo $row['NAMA']; ?>" autocomplete="off" />
              </div>
            </div>
            <h5 class="card-inside-title">Pendidikan Terakhir</h5>
            <div class="form-group">
              <div class="form-line">
                <input type="text" name="PENDIDIKAN" class="form-control" value="<?php echo $row['PENDIDIKAN']; ?>" autocomplete="off" />
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="form-line">
                <input type="text" name="TELP" value="<?php echo $row['TELP']; ?>" class="form-control" autocomplete="off"/>
              </div>
            </div>
            ...
            <div class="form-group pull-right">
              <a href="data_anggota.php" class="btn btn-danger"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
              ...
              $sql = oci_parse($conn, "DECLARE BEGIN PANG('UPDATE', '$ID', '$NAMA', '$PENDIDIKAN', '$ALAMAT', 
              '$TELP', '$EMAIL'); END;");
