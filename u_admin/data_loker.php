...
$char = '0987654321ABCDEFGHIJKLMNOPQRSTUVWXYZ';
      ...
      <div class="container-fluid">
        ...
        <div class="table-responsive">
          <table id="tabel-data" class="table table-bordered table-striped table-hover js-basic-example dataTabl">
            ...
            <tbody>
              <?php
              include "../koneksi.php";
              $sql = ociparse($conn, "select * from LOKER WHERE KUOTA != 0");
              ociexecute($sql);
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href='ubah_loker.php?ID_LOKER=<?php echo $row['ID_LOKER']; ?>' class="btn btn-warning"><i class="fas fa-pencil"></i></a>
                    <a href='hapus_loker.php?ID_LOKER=<?php echo $row['ID_LOKER']; ?>' onclick=" return confirm('Anda Yakin Menghapus Data Ini');" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
        ...
        <div class="body">
          <form role="form" action="" method="POST">
            ...
            <input type="text" name="ID_LOKER" class="form-control" value="<?php echo $idBel; ?>" hidden/>
            ...
            <div class="form-group">
              <div class="form-line">
                <input type="text" name="POSISI" class="form-control" autocomplete="off"/>
              </div>
            </div>
            <h5 class="card-inside-title">Alamat</h5>
            <div class="form-group">
              <div class="form-line">
                <textarea rows="1" name="ALAMAT" autocomplete="off" class="form-control no-resize auto-growth"></textarea>
              </div>
            </div>
            <h5 class="card-inside-title">Persyaratan</h5>
            <div class="form-group">
              <div class="form-line">
                <textarea rows="3" name="SYARAT" autocomplete="off" class="form-control no-resize auto-growth"></textarea>
              </div>
            </div>
            <h5 class="card-inside-title">Tanggal Upload</h5>
            <div class="form-group">
              <div class="form-line">
                <input type="date" name="TANGGAL_UPLOAD" class="form-control" />
              </div>
            </div>
            <h5 class="card-inside-title">Expired</h5>
            <div class="form-group">
              <div class="form-line">
            ...
            <div class="form-group">
              <div class="form-line">
                <input type="text" name="KUOTA" class="form-control" autocomplete="off" />
              </div>
            </div>
        ...
        if (isset($_POST['submit'])) {
          ...
          $ALAMAT = $_POST["ALAMAT"];
          $SYARAT = $_POST["SYARAT"];
          $TANGGAL_UPLOAD = date("d-m-Y", strtotime($_POST['TANGGAL_UPLOAD']));
          $EXPIRED = date("d-m-Y", strtotime($_POST['EXPIRED']));
          $KUOTA = $_POST["KUOTA"];

          $sql = ociparse($conn, "INSERT INTO LOKER (ID_LOKER, NAMA_PERUSAHAAN, POSISI, ALAMAT, SYARAT, TANGGAL_UPLOAD, EXPIRED, KUOTA) VALUES ('$ID_LOKER', '$NAMA_PERUSAHAAN', '$POSISI', '$ALAMAT', '$SYARAT', to_date('$TANGGAL_UPLOAD','dd-mm-yyyy'), to_date('$EXPIRED','dd-mm-yyyy'), $KUOTA)");
